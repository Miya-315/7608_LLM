...
export BASE_FOLDER="/gfs/space/chatrl/public/models/ZhipuAI/"
...
CKPT_ARGS=(
   --hf-checkpoint /gfs/space/chatrl/public/models/ZhipuAI/GLM-4.7-Flash
   --ref-load /gfs/space/chatrl/public/models/ZhipuAI/GLM-4.7-Flash-torch-dist
   --load ${BASE_FOLDER}/GLM-4.7-Flash_slime/
   --save ${BASE_FOLDER}/GLM-4.7-Flash_slime/
   --save-interval 1000
)

SFT_ARGS=(
   --rollout-function-path slime.rollout.sft_rollout.generate_rollout
   --prompt-data /gfs/space/chatrl/users/djy/0121/sft_code/math_with_tools_slime_format.jsonl
   --input-key messages
   # --apply-chat-template
   # --rollout-shuffle
   --num-epoch 3
