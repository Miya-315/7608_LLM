...
def core_transformer_config_from_args(args, config_class=None):
    ...
    # 移除 pipeline stage 字段，彻底防止冲突
    if 'num_layers_in_first_pipeline_stage' in kw_args:
        del kw_args['num_layers_in_first_pipeline_stage']
    if 'num_layers_in_last_pipeline_stage' in kw_args:
        del kw_args['num_layers_in_last_pipeline_stage']
